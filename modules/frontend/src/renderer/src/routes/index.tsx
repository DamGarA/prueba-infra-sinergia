// import { $UserRole } from '@renderer/constants'

import { createBrowserRouter } from 'react-router'
import AppLayout from '@renderer/layout/App.layout'
import AuthLayout from '@renderer/layout/Auth.layout'
import { AppRoutes } from './app.routes'
import { AuthRoutes } from './auth.routes'
// import NotFoundPage from '@renderer/pages/404'
// import LogIn from '@renderer/pages/log-in'
// import Profile from '@renderer/pages/profile'
// import SignUp from '@renderer/pages/sign-up'
// import { Suspense } from 'react'
// import { BrowserRouter, Route, Routes as AppRoutes } from 'react-router'
import { UserRoutes } from './user.routes'
import { AppFallback } from '@renderer/components/app-fallback'
